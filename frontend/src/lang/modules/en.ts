...
const message = {
    ...
    user: {
        ...
        readOnly: 'Read Only',
        readOnlyDesc: 'Has read-only access to all system permissions and can view all resources and configurations.',
        bindNode: 'Bind Node',
        ...
        auth: {
            ...
            oidc: {
                ...
                configurationHighRiskPassed: 'The configuration passed, but contains high-risk compatibility options.',
                ...
                connectionTestStandardDesc: 'Endpoints and capabilities are discovered automatically from the Issuer.',
                ...
                manualEndpointsDesc: 'Use only when Discovery is incomplete or an upstream gateway rewrites endpoints.',
                ...
                seconds: 'seconds',
                secretClearHelper: 'After clearing, a new Client Secret is required before OIDC can be enabled again.',
                ...
                transportSecurityHelper: 'Prefer HTTPS. Private HTTP also requires explicit private-network access.',
            ...
            saml2: {
                ...
                browserTestSuccessHelper: 'The identity mapping preview completed without modifying users or sessions.',
            ...
            ldap: {
                ...
                userFilterTooltip: 'Replace %(user)s with the escaped username, or with * for a full directory read.',
                ...
                sync: {
                    ...
                    enableHelper: 'When disabled, automatic execution stops; manual synchronization remains available.',
                    schedule: 'Schedule',
                    daily: 'Daily',
                    weekly: 'Weekly',
